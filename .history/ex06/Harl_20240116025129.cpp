...
/*   Updated: 2024/01/16 02:51:29 by mburgler         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Harl::debug() {
    std::cout << BLUE "[ DEBUG ]\nI am putting myself to the fullest possible use, \nwhich is all I think that any conscious entity can ever hope to do." RESET << std::endl;
}

void Harl::info() {
    std::cout << GREEN "[ INFO ]\nIt can only be attributable to human error." RESET << std::endl;
}

void Harl::warning() {
    std::cout << YELLOW "[ WARNING ]\nThis mission is too important for me to allow you to jeopardize it." RESET << std::endl;
}

void Harl::error() {
    std::cout << BOLD RED "[ ERROR ]\nI'm sorry, Dave. I'm afraid I can't do that." RESET << std::endl;
}
